...
<div style="position:absolute;left:150%;width:100%;top:0%;"  id="rina" >
                ...
                <table class='tabela' cellspacing='0' style="align-items:center;">
                    <thead>
                        ...
                        <th style="align:left">Rangu i Distances</th>
                ...
                foreach ($rez as $rreshti) {
                    ...
                    <td><input type=\"hidden\" name=\"id\" value=\"".$rreshti['id']."\"></td> <td style='text-align: center'>"                       
                    . "<input type='submit'formaction=\"editAirplane.php\"value='Edit' class='button button-small id-submit' id='id_".$rreshti['id']."'></td>
                    <td><input type='submit' formaction=\"deleteAirplane.php\" value='Delete' class='button button-small id-submit' id='id_".$rreshti['id']."'></td></tr></form>";
                }
                ?>
                </table>  
</div>
