...
<div style="position:absolute;left:150%;width:100%;top:0%;" id="rina" >
                ...
                foreach ($rez as $rreshti) {
                    echo "<form method=\"POST\"><tr><td>".$rreshti['origin']."</td><td>".$rreshti['destination']."</td><td>".$rreshti['flight_date']."</td><td>".$rreshti['flight_return']."</td><td>".$rreshti['Qmimi']."</td><td><input type=\"hidden\" name=\"id\" value=\"".$rreshti['id']."\"></td> <td style='text-align: center'>"                       
                    . "<input type='submit'formaction=\"editFlight.php\"value='Edit' class='button button-small id-submit' id='id_".$rreshti['id']."'></td><td><input type='submit' formaction=\"deleteFlight.php\" value='Delete' class='button button-small id-submit' id='id_".$rreshti['id']."'></td></tr></form>";
                }
                ?>
                </table>  
</div>
